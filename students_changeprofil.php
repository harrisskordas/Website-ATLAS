...
<meta charset="utf-8">
    <title>Atlas - Student edit profile</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <p><a href="index.php"><img src="C:\xampp\htdocs\startbootstrap-agency-gh-pages\atlas_icon.png" style="width:100px;height:100px;margin-top:10px;"></a></p>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="" class="nav-item nav-link"><b>Αναζήτηση Θέσεων</b></a>
                <a href="" class="nav-item nav-link"><b>Οι θέσεις μου</b></a>
                <a href="" class="nav-item nav-link"><b>Αγαπημένες Θέσεις</b></a>
            </div>
            <button type="button" class="btn text-dark" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fa fa-search"></i></button>
            <div class="dropdown">
                <button class="dropbtn"><i class='fas fa-user-circle' style='font-size:25px;color: rgb(238, 238, 238)'></i></button>
    ...
    <!-- Full Screen Search End -->
      ...
      <div class="container-fluid position-relative pt-5 wow fadeInUp" data-wow-delay="0.1s" style="z-index: 1;">
        <ul class="breadcrumb">
            ...
            <li style="font-size: 14px;"><a href="λινκ αρχικης εγγραφής">Τα Στοιχεία μου</a></li>
            <li style="font-size: 14px;color: #000;">Επεξεργασία των Στοιχείων μου</li>
        </ul>
        <p style="font-size:19px;margin-left: 400px;color: #000;"><b>Επεξεργασία των Στοιχείων μου</b></p><br><br>
                <form action="edit_profile_student.php" method="post" class="form" style="width:700px">
                    <p style="font-size:18px;margin-left: 200px;color: #000;">Στοιχεία Λογαριασμού</p>
                    <div class="input-group">
                        <input type="file" name="image" id="image" />
                    </div>
                    <div class="text">
                        <label for="image" ><b>Φωτογραφία:</b></label>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="text">
                        <label for="email" style="margin-right:-100px;margin-top:-67px"><b>Email:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="password" name="password" id="password" />
                    </div>
                    <div class="text">
                        <label for="password" style="margin-right:-100px;margin-top:-67px"><b>Νέος Κωδικός:</b></label>
                    </div>
                    <br><br><p style="font-size:18px;margin-left: 200px;color: #000;">Προσωπικά Στοιχεία</p>
                    
                    <div class="input-group">
                        <input type="text" name="fullname" id="fullname" />
                    </div>
                    <div class="text">
                        <label for="fullname" style="margin-top:-70px"><b>Ονοματεπώνυμο:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="address" id="address" />
                    </div>
                    <div class="text">
                        <label for="address" style="margin-top:-70px"><b>Διεύθυνση:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="date" name="dob" id="dob" />
                    </div>
                    <div class="text">
                        <label for="dob" style="margin-top:-70px"><b>Ημερομηνία Γέννησης:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="tel" name="phone" id="phone" />
                    </div>
                    <div class="text">
                        <label for="phone" style="margin-top:-70px"><b>Τηλέφωνο:</b></label>
                    </div>
                    <br><br><p style="font-size:18px;margin-left: 200px;color: #000;">Στοιχεία Βιογραφικού</p>
                    <div class="input-group">
                        <input type="text" name="uni" id="uni" />
                    </div>
                    <div class="text">
                        <label for="uni" style="margin-top:-70px"><b>Σχολή:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="uni_part" id="uni_part" />
                    </div>
                    <div class="text">
                        <label for="uni_part" style="margin-top:-70px"><b>Τμήμα:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="number" name="sem" id="sem" />
                    </div>
                    <div class="text">
                        <label for="sem" style="margin-top:-70px"><b>Εξάμηνο:</b></label>
                    </div>
                    <div class="input-group">
                        <input type="file" name="bio" id="bio" />
                    </div>
                    <div class="text">
                        <label for="bio" style="margin-top:-70px"><b>Βιογραφικό:</b></label>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="text_aboutme">
                        <label for="aboutme"><b>Σχετικά με εμένα:</b></label>
                    </div>
                    <button style="margin-top:60px;margin-left: 200px;border: none;color: white;background-color:  #026fd4;padding: 4px 21px; cursor:pointer;border-radius: 0.25rem; box-shadow: 0 0 0 2px #fff, 0 0 0 3px var(--primary-color);">Υποβολή</button>
                    <button style="margin-top:60px;margin-left:20px;border: none;color: black;background-color:  #cfcece;padding: 4px 21px;cursor:pointer;border-radius: 0.25rem;">Ακύρωση</button>
                </form>
            </div>
