...
<meta charset="utf-8">
    <title>Atlas - User's Profile</title>
    ...
    <!-- Full Screen Search End -->
      ...
      <div class="container-fluid position-relative pt-5 wow fadeInUp" data-wow-delay="0.1s" style="z-index: 1;">
        <ul class="breadcrumb">
            ...
            <li style="font-size: 14px;color:black;">Τα Στοιχεία μου</li>
        </ul>
        <p style="font-size:19px;margin-left: 250px;color: #000;"><b>Τα Στοιχεία μου</b></p><br><br>
                <form action="#" class="form">
                    <button style='height:40px;margin-left:800px;font-size:16px;color:black;background-color: rgb(238, 238, 238);border: 1px solid #b8b8bf;border-radius: 0.5rem;'>Επεξεργασία <i class='far fa-edit' style='font-size:16px'></i></button>
                    <hr style="margin-top:55px; border: 0px solid #b8b8bf;">
                    <i class='fas fa-user-circle' style='font-size:140px;color: rgb(238, 238, 238);'></i>
                    <div class="text_name">
                    ...
                    <div class="profil_form">
                        ...
                        <p style="font-size:17px;">Προσωπικά Στοιχεία</p>
                        <label for="out_address" style="font-size:15px;"><b>Διεύθυνση:</b></label>
                        <output name="out_address" for="address"></output><br>
                        <label for="out_dob" style="font-size:15px;"><b>Ημερομηνία Γέννησης:</b></label>
                        <output name="out_dob" for="dob"></output><br>
                        <label for="out_phone" style="font-size:15px;"><b>Τηλέφωνο:</b></label><br>
                        <output name="out_phone" for="phone"></output>
                        <p style="font-size:17px;">Στοιχεία Βιογραφικού:</p>
                        <label for="out_uni" style="font-size:15px;"><b>Σχολή:</b></label>
                        <output name="out_uni" for="uni"></output><br>
                        <label for="out_uni_part" style="font-size:15px;"><b>Τμήμα:</b></label>
                        <output name="out_uni_part" for="uni_part"></output><br>
                        <label for="out_sem" style="font-size:15px;"><b>Εξάμηνο:</b></label>
                        <output name="out_sem" for="sem"></output><br>
                        <label for="out_bio" style="font-size:15px;"><b>Βιογραφικό:</b></label>
                        <output name="out_bio" for="bio"></output>
                        <!-- <label for="out_aboutme" style="margin-top:-100px;">Σχετικά με εμένα</label> -->
                        <div class="form_text">
                        ...
                        <hr style="border: 0px solid #b8b8bf;margin-top: 300px;width: 960px;margin-left: -30px;"><br>
                        <button style="width:220px;margin-left:700px;height:40px;font-size:16px;color:white;background-color:rgb(173, 8, 8);border:solid 1px rgb(173, 8, 8);border-radius: 0.5rem;">Διαγραφή Λογαριασμού <i class="material-icons" style="font-size:16px;">delete</i></button>
                    </div>
                </form>
            </div>
